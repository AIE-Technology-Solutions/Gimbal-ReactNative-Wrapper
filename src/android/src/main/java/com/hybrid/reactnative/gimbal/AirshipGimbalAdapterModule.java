 ...
 */
public class GimbalAdapterModule extends ReactContextBaseJavaModule {
     ...
     */
    public GimbalAdapterModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }
